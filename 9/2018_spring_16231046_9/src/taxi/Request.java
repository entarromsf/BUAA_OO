	...
	public void handle() {
		...
		*/
		try {
			...
			if(!m1.find()) signopen = false;
			if(!m2.find()) signclose = false;
			...
			if(src.equals(dst)) {sign = false;signopen = false;signclose = false;}
		} catch (Exception e) {sign = false;signopen = false;signclose = false; return;}
	}
