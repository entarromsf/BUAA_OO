...
public class Input extends Thread{
	...
	private City city;
	public Input(ArrayList<int[]> request,ArrayList<taxi> taxi_list,TaxiGUI gui,City city) {
	...
	public void check(String str) {		
		/**
		 * @REQUIRES:None;
		 * @MODIFIES:taxi_list,change,city;
		 * @EFFECTS:None;
		 */
		int[] req =new int[4];
								...
								while(!string.equals("#end_taxi")) {
									...
									if(string.matches(reg)) {
										...
										if(wrong==0) {
											...
											taxi taxi = new taxi(Integer.parseInt(stt[0]),Integer.parseInt(stt[3]),Integer.parseInt(stt[4]),gui,city,change[Integer.parseInt(stt[0])]);
									...
									taxi_thread.creat_taxilist(gui,taxi_list,city,had_build);
							}
